            ...
            <div class="card">
                <div class="card-body text-center">
                    <img src="{{ url("storage/$post->destaque") }}" class="img-fluid  mb-1" style="width: 450px;" alt="Imagem do usuário">
                     ...
                     <a href="{{ url("storage/{$post->destaque}") }}" download><svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" class="bi bi-arrow-down-square" viewBox="0 0 16 16">
