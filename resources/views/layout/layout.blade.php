        ...
        <div class="container-fluid">
            <div class="d-flex justify-content-between align-items-center red-header">
                <div class="d-flex align-items-center">
                    ...
                    @auth
                        <img src="{{ Auth::user()->imageUser ? url('storage/' . Auth::user()->imageUser) : 'https://media.istockphoto.com/vectors/person-gray-photo-placeholder-man-vector-id1152265845?k=20&m=1152265845&s=170667a&w=0&h=RZF10k2BsiHIjCrVDuESMN9M7kb81k7cyk74F52jvdg=' }}"
                            alt="Profile Image" class="profile-img" id="dropdown-icon">
                ...
                @auth
                    ...
                    <div id="dropdown-menu" class="dropdown-menu ">
                        ...
                        <a href="{{ route('post-index') }}">Publicações</a>
                         ...
                         <a href="{{ route('destaque-index') }}">Destaques</a>
